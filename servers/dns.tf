...
resource "cloudflare_record" "ubuntu_tm_id_au" {
  ...
  value  = "${aws_eip.ubuntu_tm_id_au.public_ip}"
  type   = "A"
}
...
resource "cloudflare_record" "ubuntu_int_tm_id_au" {
  ...
  value  = "${aws_eip.ubuntu_tm_id_au.private_ip}"
  type   = "A"
}
...
resource "cloudflare_record" "centos_tm_id_au" {
  ...
  value  = "${aws_eip.centos_tm_id_au.public_ip}"
  type   = "A"
}
...
resource "cloudflare_record" "centos_int_tm_id_au" {
  ...
  value  = "${aws_eip.centos_tm_id_au.private_ip}"
  type   = "A"
}
